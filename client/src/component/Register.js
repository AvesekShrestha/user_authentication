...
export default function Register() {
    ...
    const handelOnClick= async(e)=>{
        ...
        try{
            const response = await axios.post(`${config.BASE_URL}/auth/register`, {email , password});
    ...
    return (
        <>
            <form className="form-signin">
                ...
                <button className="btn btn-lg btn-primary btn-block" onClick={handelOnClick} >Register</button>
            </form>
